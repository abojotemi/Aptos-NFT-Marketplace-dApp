...
const MyNFTs: React.FC = () => {
  ...
  const marketplaceAddr = "0xa9c2def31081a7eb7413fc4ec419bf1e92a0a40b7f24cc3c4750b4d67be8d7ca";
  ...
  const handleStartAuction = async () => {
    ...
    try {
      ...
      const entryFunctionPayload = {
        type: "entry_function_payload",
        function: `${marketplaceAddr}::NFTMarketplace::initialize_auction`,
        type_arguments: [],
        arguments: [selectedNft.id.toString(), durationInSeconds.toString()],
      };
    ...
    >
      ...
      <Modal
        ...
        footer={[
          ...
          <Button key="submit" type="primary" onClick={handleStartAuction}>
            Start Auction
          </Button>,
        ]}
      >
